...
/*              
	...
	private void createMerchant() throws ServiceException {
		...
		store.setStoreaddress("494427 Street address");
		store.setStorepostalcode("NLR-NLR");
		store.setStoreEmailAddress("hari@test.com");
		store.setDomainName("localhost:8090");
		store.setStoreTemplate("september");
